...
var models = /*#__PURE__*/Object.freeze({
  ...
  GitIndex: GitIndex,
  GitObject: GitObject,
  GitPackIndex: GitPackIndex,
  GitPktLine: GitPktLine,
  GitRefSpec: GitRefSpec,
  GitRefSpecSet: GitRefSpecSet,
  GitTree: GitTree,
  SignedGitCommit: SignedGitCommit
});
...
class GitRemoteHTTP {
  ...
  static async connect ({ service, url, auth: auth$$1, stream: stream$$1 }) {
    // Auto-append the (necessary) .git if it's missing.
    if (!url.endsWith('.git')) url = url += '.git';
    let headers = {};
...
var managers = /*#__PURE__*/Object.freeze({
  ...
  GitRefManager: GitRefManager,
  GitRemoteConnection: GitRemoteConnection,
  GitRemoteHTTP: GitRemoteHTTP,
  GitRemoteManager: GitRemoteManager,
  GitShallowManager: GitShallowManager
});
